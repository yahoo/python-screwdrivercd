...
class DocStub(object):
    __version__ = '0.0.0'
    __name__ = 'Unknown'
    __copyright__ = 'Copyright 2018 Oath Inc.'
    
try:
    import ouroath.screwdrivercd as doc_module
except ImportError:
    doc_module = DocStub()
...
project = doc_module.__name__
copyright = ''
if hasattr(doc_module, '__copyright__'):
    copyright = doc_module.__copyright__
...
try:
    ...
    available_theme_settings['cloudsp']['options'] = {
        'roottarget': 'index'
    }
except ImportError:
    pass
...
try:
    ...
    available_theme_settings['bootstrap']['path'] = sphinx_bootstrap_theme.get_html_theme_path()
...
try:
    ...
    available_theme_settings['read_the_docs']['path'] = [sphinx_rtd_theme.get_html_theme_path()]
...
try:
    ...
    github_doc_root = 'https://git.ouroath.com/pages/dhubbard/ouroath.screwdrivercd'
    USE_MARKDOWN = True
except ImportError:
    USE_MARKDOWN = False
...
extlinks = {
    ...
    'jira': ('https://jira.ouroath.com/browse/%s', 'jira:'),
    'screwdriver_v3': ('https://screwdriver.corp.yahoo.com/projects/%s', 'screwdriver_v3:'),
    'screwdriver': ('https://screwdriver.ouroath.com/pipelines/%s', 'screwdriver:'),
}
